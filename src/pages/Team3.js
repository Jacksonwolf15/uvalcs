    ...
    if (bigscreen) {
        ...
        <Grommet  >
            ...
            <Box align='center' round='small' background='rgba(255,255,255,.8)' style={{marginLeft: '10%', marginRight: '10%', boxShadow:'0 0 .25em rgba(0,0,0,.25)', color: 'black'}} gridArea="roster">
                ...
                <TableBody>
                    <TableRow>
                    <TableCell><a style={{color: 'black'}} href='https://na.op.gg/summoner/userName=Shoushukann'>Shoushukann</a></TableCell>
                    <TableCell>Gold 4</TableCell>
                    </TableRow>
                    <TableRow>
                    <TableCell><a style={{color: 'black'}} href='https://na.op.gg/summoner/userName=Sooren'>Sooren</a></TableCell>
                    <TableCell>Gold 4</TableCell>
                    </TableRow>
                    <TableRow>
                    <TableCell><a style={{color: 'black'}} href='https://na.op.gg/summoner/userName=SushiKraver'>SushiKraver</a></TableCell>
                    <TableCell>Diamond 3</TableCell>
                    </TableRow>
                    <TableRow>
                    <TableCell><a style={{color: 'black'}} href='https://na.op.gg/summoner/userName=Fedexter'>Fedexter</a></TableCell>
                    <TableCell>Silver 2</TableCell>
                    </TableRow>
                    <TableRow>
                    <TableCell><a style={{color: 'black'}} href='https://na.op.gg/summoner/userName=vtnx'>vtnx</a></TableCell>
                    <TableCell>Silver 1</TableCell>
                    </TableRow>
                </TableBody>
                </Table>
                <h2>Point Total: 159.2/175</h2>
                <Button href='https://na.op.gg/multi/query=Shoushukann%2CSooren%2Csushikraver%2CFedexter%2Cvtnx' primary style={{fontSize: 'calc(10px + 1.5vmin)', color: 'white', fontWeight: 'bold', backgroundColor: '#c71a1a', border: '#c71a1a'}} label='Team OP.GG'/>
            </Box>
    ...
    return(
        <Grommet  >
            ...
            <Box align='center' round='small' background='rgba(255,255,255,.8)' style={{paddingBottom: '2%', marginLeft: '10%', marginRight: '10%', boxShadow:'0 0 .25em rgba(0,0,0,.25)', color: 'black'}} gridArea="roster">
                ...
                <h2>Point Total: 159.2/175</h2>
                <Button href='https://na.op.gg/multi/query=Shoushukann%2CSooren%2Csushikraver%2CFedexter%2Cvtnx' style={{fontSize: 'calc(10px + 1.5vmin)', color: 'white', fontWeight: 'bold', backgroundColor: '#c71a1a', border: '#c71a1a'}} label='Team OP.GG'/>
            </Box>
