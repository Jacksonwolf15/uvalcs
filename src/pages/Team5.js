          ...
          <Box align='center' round='small' background='rgba(255,255,255,.8)' style={{marginLeft: '10%', marginRight: '10%', boxShadow:'0 0 .25em rgba(0,0,0,.25)', color: 'black'}} gridArea="roster">
            ...
            <Table>
              ...
              <TableBody>
                ...
                <TableRow>
                  <TableCell><a style={{color: 'black'}} target="_blank" href='https://na.op.gg/summoner/userName=Margao'>Margao</a></TableCell>
                  <TableCell>Silver 2</TableCell>
                </TableRow>
                <TableRow>
                  <TableCell><a style={{color: 'black'}} target="_blank" href='https://na.op.gg/summoner/userName=Taegon'>Taegon</a></TableCell>
                  <TableCell>Masters</TableCell>
                </TableRow>
                <TableRow>
                  <TableCell><a style={{color: 'black'}} target="_blank" href='https://na.op.gg/summoner/userName=FirstDegreeSVG'>FirstDegreeSVG</a></TableCell>
                  <TableCell>Silver 1</TableCell>
                </TableRow>
              </TableBody>
            </Table>
            <h2>Point Total: 174.8/175</h2>
            <Button target="_blank" href='https://na.op.gg/multi/query=helsech%2C%20taegon%2C%20firstdegreesvg%2C%20margao%2C%20m%C4%B1nt%20tea' style={{fontSize: 'calc(10px + 1.5vmin)', color: 'black', fontWeight: 'bold', backgroundColor: '#ff41ef', border: '#ff41ef'}} label='Team OP.GG'/>
          </Box>
