    ...
    if (bigscreen) {
        ...
        <Grommet>
            ...
            <Box align='center' round='small' background='rgba(255,255,255,.8)' style={{marginLeft: '10%', marginRight: '10%', boxShadow:'0 0 .25em rgba(0,0,0,.25)', color: 'black'}} gridArea="roster">
                ...
                <TableBody>
                    <TableRow>
                    <TableCell><a style={{color: 'black'}} href='https://na.op.gg/summoner/userName=Von+Bon'>Von Bon</a></TableCell>
                    <TableCell>Diamond 4</TableCell>
                    </TableRow>
                    <TableRow>
                    <TableCell><a style={{color: 'black'}} href='https://na.op.gg/summoner/userName=Lucaspeng'>Lucaspeng</a></TableCell>
                    <TableCell>unranked</TableCell>
                    </TableRow>
                    <TableRow>
                    <TableCell><a style={{color: 'black'}} href='https://na.op.gg/summoner/userName=Klauspeng'>Klauspeng</a></TableCell>
                    <TableCell>Silver 4</TableCell>
                    </TableRow>
                    <TableRow>
                    <TableCell><a style={{color: 'black'}} href='https://na.op.gg/summoner/userName=Tulla3212'>Tulla3212</a></TableCell>
                    <TableCell>Plat 3</TableCell>
                    </TableRow>
                    <TableRow>
                    <TableCell><a style={{color: 'black'}} href='https://na.op.gg/summoner/userName=Spades+Gambit'>Spades Gambit</a></TableCell>
                    <TableCell>Bronze 1</TableCell>
                    </TableRow>
                </TableBody>
                </Table>
                <h2>Point Total: 162.8/175</h2>
                <Button href='https://na.op.gg/multi/query=Von%20Bon%2Clukaspeng%2Cklauspeng%2CSpades%20Gambit%2CTulla3212' primary style={{fontSize: 'calc(10px + 1.5vmin)', color: 'white', fontWeight: 'bold', backgroundColor: 'black', border: 'black'}} label='Team OP.GG'/>
            </Box>
