          ...
          <Box align='center' round='small' background='rgba(255,255,255,.8)' style={{marginLeft: '10%', marginRight: '10%', boxShadow:'0 0 .25em rgba(0,0,0,.25)', color: 'black'}} gridArea="roster">
            ...
            <Table>
              ...
              <TableBody>
                ...
                <TableRow>
                  <TableCell><a style={{color: 'black'}} target="_blank" href='https://na.op.gg/summoner/userName=ToeFungus'>ToeFungus</a></TableCell>
            ...
            <Button target="_blank" href='https://na.op.gg/multi/query=ToeFungus%2C%20Funkypants32%2C%20jSurd03%2C%20Levoria%2C%20Taesung' primary style={{fontSize: 'calc(10px + 1.5vmin)', color: 'black', fontWeight: 'bold', backgroundColor: '#ff80d2', border: '#ff80d2'}} label='Team OP.GG'/>
          </Box>
