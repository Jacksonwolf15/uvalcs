        ...
        >
          ...
          <Box align='center' round='small' background='rgba(255,255,255,.8)' style={{marginLeft: '10%', marginRight: '10%', boxShadow:'0 0 .25em rgba(0,0,0,.25)', color: 'black'}} gridArea="roster">
            ...
            <Table>
              ...
              <TableBody>
                <TableRow>
                  <TableCell><a style={{color: 'black'}} href='https://na.op.gg/summoner/userName=Plump+Dumpling'>Plump Dumpling</a></TableCell>
                  <TableCell>Plat 4</TableCell>
                </TableRow>
                <TableRow>
                  <TableCell><a style={{color: 'black'}} href='https://na.op.gg/summoner/userName=Lord+Bandito'>Lord Bandito</a></TableCell>
                  <TableCell>Plat 1</TableCell>
                </TableRow>
                <TableRow>
                  <TableCell><a style={{color: 'black'}} href='https://na.op.gg/summoner/userName=Wedda'>Wedda</a></TableCell>
                  <TableCell>Bronze 1</TableCell>
                </TableRow>
                <TableRow>
                  <TableCell><a style={{color: 'black'}} href='https://na.op.gg/summoner/userName=thicccactus'>thicccactus</a></TableCell>
                  <TableCell>Gold 1</TableCell>
                </TableRow>
                <TableRow>
                  <TableCell><a style={{color: 'black'}} href='https://na.op.gg/summoner/userName=l+thelaw+l'>l TheLaw l</a></TableCell>
