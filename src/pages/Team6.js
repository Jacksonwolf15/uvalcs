...
const config = {
  ...
  function Team6() {
    ...
    const captain = 'Plump Dumpling'
  
    useEffect(()=> {
      const dbRef = ref(getDatabase());
      get(child(dbRef, 'team6/games')).then((snapshot) => {
      if (snapshot.exists()) {
    ...
    function writeGameData(json) {
      ...
      const postListRef = ref(db, 'team6/games/');
        ...
        >
          ...
          <Box align='center' round='small' background='rgba(255,255,255,.8)' style={{marginLeft: '10%', marginRight: '10%', boxShadow:'0 0 .25em rgba(0,0,0,.25)', color: 'black'}} gridArea="roster">
            ...
            <Table>
              ...
              <TableBody>
                <TableRow>
                  <TableCell><a style={{color: 'black'}} target="_blank" href='https://na.op.gg/summoner/userName=Plump+Dumpling'>Plump Dumpling</a></TableCell>
                ...
                <TableRow>
                  <TableCell><a style={{color: 'black'}} target="_blank" href='https://na.op.gg/summoner/userName=im+harold'>im harold</a></TableCell>
            ...
            <h2>Point Total: 177/175</h2>
            <Button target="_blank" href='https://na.op.gg/multi/query=Plump%20Dumpling%2CLord%20Bandito%2CWedda%2Cim%20harold%2CL%20TheLaw%20L' primary style={{fontSize: 'calc(10px + 1.5vmin)', color: 'black', fontWeight: 'bold', backgroundColor: '#22e393', border: '#22e393'}} label='Team OP.GG'/>
          </Box>
          ...
          <Box align='center' round='small' background='rgba(255,255,255,.8)' style={{marginLeft: '10%', marginRight: '10%', boxShadow:'0 0 .25em rgba(0,0,0,.25)', color: 'black', paddingBottom: '2%'}} gridArea="roster">
            ...
            <Table>
              ...
              <TableBody>
                ...
                <TableRow>
                  <TableCell><a style={{color: 'black'}} target="_blank" href='https://na.op.gg/summoner/userName=thicccactus'>im harold</a></TableCell>
                  <TableCell>Silver 1</TableCell>
                </TableRow>
                <TableRow>
                  <TableCell><a style={{color: 'black'}} target="_blank" href='https://na.op.gg/summoner/userName=l+thelaw+l'>l TheLaw l</a></TableCell>
