        ...
        >
          ...
          <Box align='center' round='small' background='rgba(255,255,255,.8)' style={{marginLeft: '10%', marginRight: '10%', boxShadow:'0 0 .25em rgba(0,0,0,.25)', color: 'black'}} gridArea="roster">
            ...
            <Table>
              ...
              <TableBody>
                <TableRow>
                  <TableCell><a style={{color: 'black'}} href='https://na.op.gg/summoner/userName=verule'>Verule</a></TableCell>
                  <TableCell>Silver 1</TableCell>
                </TableRow>
                <TableRow>
                  <TableCell><a style={{color: 'black'}} href='https://na.op.gg/summoner/userName=Frostsharks'>Frostsharks</a></TableCell>
                  <TableCell>Diamond 3</TableCell>
                </TableRow>
                <TableRow>
                  <TableCell><a style={{color: 'black'}} href='https://na.op.gg/summoner/userName=Can Milk Those'>Can Milk Those</a></TableCell>
                  <TableCell>Gold 3</TableCell>
                </TableRow>
                <TableRow>
                  <TableCell><a style={{color: 'black'}} href='https://na.op.gg/summoner/userName=Fire155'>Fire155</a></TableCell>
                  <TableCell>Gold 1</TableCell>
                </TableRow>
                <TableRow>
                  <TableCell><a style={{color: 'black'}} href='https://na.op.gg/summoner/userName=DespicableO'>DespicableO</a></TableCell>
                  <TableCell>Silver 4</TableCell>
                </TableRow>
              </TableBody>
            </Table>
            <h2>Point Total: 170.6/175</h2>
            <Button href='https://na.op.gg/multi/query=verule%2C%20can%20milk%20those%2C%20frostsharks%2C%20fire155%2C%20despicableo' style={{fontSize: 'calc(10px + 1.5vmin)', color: 'white', fontWeight: 'bold', backgroundColor: '#0d0dde', border: '#0d0dde'}} label='Team OP.GG'/>
          </Box>
