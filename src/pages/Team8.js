...
const config = {
  ...
  function Team8() {
    ...
    const captain = 'Bejewelled'
  
    useEffect(()=> {
      const dbRef = ref(getDatabase());
      get(child(dbRef, 'team8/games')).then((snapshot) => {
      if (snapshot.exists()) {
    ...
    function writeGameData(json) {
      ...
      const postListRef = ref(db, 'team8/games/');
    ...
    return(
      <Grommet  >
        <div class='bgjew'></div>
        <div class='bgjew bg2'></div>
        <div class='bgjew bg3'></div>
        ...
        >
          ...
          <Box align='center' round='small' background='rgba(255,255,255,.8)' style={{marginLeft: '10%', marginRight: '10%', boxShadow:'0 0 .25em rgba(0,0,0,.25)', color: 'black'}} gridArea="roster">
            ...
            <Table>
              ...
              <TableBody>
                <TableRow>
                  <TableCell><a style={{color: 'black'}} href='https://na.op.gg/summoner/userName=Bejewelled'>Bejewelled</a></TableCell>
                  <TableCell>Gold 2</TableCell>
                </TableRow>
                <TableRow>
                  <TableCell><a style={{color: 'black'}} href='https://na.op.gg/summoner/userName=hentai+evelynn'>Hentai Evelynn</a></TableCell>
                  <TableCell>Diamond 3</TableCell>
                </TableRow>
                <TableRow>
                  <TableCell><a style={{color: 'black'}} href='https://na.op.gg/summoner/userName=DHLETHALITYSIVIR'>DHLETHALITYSIVIR</a></TableCell>
                  <TableCell>Plat 1</TableCell>
                </TableRow>
                <TableRow>
                  <TableCell><a style={{color: 'black'}} href='https://na.op.gg/summoner/userName=sarachyan'>sarachyan</a></TableCell>
                  <TableCell>Silver 3</TableCell>
                </TableRow>
                <TableRow>
                  <TableCell><a style={{color: 'black'}} href='https://na.op.gg/summoner/userName=FishNumber7'>FishNumber7</a></TableCell>
                  <TableCell>Unranked</TableCell>
                </TableRow>
              </TableBody>
            </Table>
            <h2>Point Total: 175.4/175</h2>
            <Button href='https://na.op.gg/multi/query=Bejeweled%2CFishNumber7%2CSarachyan%2CDHLETHALITYSIVIR%2CHentai%20Evelynn' primary style={{fontSize: 'calc(10px + 1.5vmin)', color: 'black', fontWeight: 'bold', backgroundColor: '#8dd2fc', border: '#8dd2fc',}} label='Team OP.GG'/>
          </Box>
          <Box align='center' round='small' background='rgba(255,255,255,.8)' style={{marginLeft: '10%', marginRight: '10%', boxShadow:'0 0 .25em rgba(0,0,0,.25)', color: 'black'}} gridArea="matches">
            ...
            />
            <Button type='submit' primary style={{fontSize: 'calc(10px + 1.5vmin)', color: 'black', fontWeight: 'bold', marginLeft: '10px', backgroundColor: '#8dd2fc', border: '#8dd2fc',}} label='Add Game'/>
            </form>
          </Box>
          </Grid>
          {games.map((game) => (
