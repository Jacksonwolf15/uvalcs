...
const config = {
  ...
  function Team9() {
    ...
    const captain = 'Taesung'
  
    useEffect(()=> {
      const dbRef = ref(getDatabase());
      get(child(dbRef, 'team9/games')).then((snapshot) => {
      if (snapshot.exists()) {
    ...
    function writeGameData(json) {
      ...
      const postListRef = ref(db, 'team9/games/');
        ...
        >
          ...
          <Box align='center' round='small' background='rgba(255,255,255,.8)' style={{marginLeft: '10%', marginRight: '10%', boxShadow:'0 0 .25em rgba(0,0,0,.25)', color: 'black'}} gridArea="roster">
            ...
            <Table>
              ...
              <TableBody>
                <TableRow>
                  <TableCell><a style={{color: 'black'}} href='https://na.op.gg/summoner/userName=Taesung'>Taesung</a></TableCell>
                  <TableCell>Plat 4</TableCell>
                </TableRow>
                <TableRow>
                  <TableCell><a style={{color: 'black'}} href='https://na.op.gg/summoner/userName=Levoria'>Levoria</a></TableCell>
                  <TableCell>Plat 2</TableCell>
                </TableRow>
                <TableRow>
                  <TableCell><a style={{color: 'black'}} href='https://na.op.gg/summoner/userName=jSURD03'>jSURD03</a></TableCell>
                  <TableCell>Silver 3</TableCell>
                </TableRow>
                <TableRow>
                  <TableCell><a style={{color: 'black'}} href='https://na.op.gg/summoner/userName=Fire155'>ToeFungus</a></TableCell>
                  <TableCell>Plat 3</TableCell>
                </TableRow>
                <TableRow>
                  <TableCell><a style={{color: 'black'}} href='https://na.op.gg/summoner/userName=FunkyPants32'>FunkyPants32</a></TableCell>
